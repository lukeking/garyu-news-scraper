# FFXIV 知識庫 / Knowledge Base

翻譯術語對照表，供 AI 分析 FFXIV 資訊時使用。
...
|---------|---------|---------|----------|-------|
| FFXIV | FFXIV | FFXIV | 遊戲 | 最終幻想 XIV；玩家直接使用英文縮寫 |
| NPC | NPC | NPC | 遊戲 | 非玩家角色 |
| ジョブ | 職業 | Job | 遊戲 | 玩家職業系統 |
...
| Endwalker | 曉月 | Endwalker | 資料片 | EN 直查 |
| Dawntrail | 黃金 | Dawntrail | 資料片 | EN 直查 |
| EverCold | 白銀 | EverCold | 資料片 | EN 直查 |
...
| 制限解除 | 解限 | Unsynced | 副本 | 無等級同步；挑戰舊副本用 |
| Raids | 團隊本 | Raids | 副本 | EN 直查 |
| Tower | 水晶塔 | Crystal Tower | 副本 | EN 直查；指水晶塔系列 |
| unsynced | 解限 | Unsynced | 副本 | EN 直查 |
| Savage | 零式 | Savage | 副本 | EN 直查 |
| Ultimate | 絕境戰 | Ultimate | 副本 | EN 直查 |

## 職能 / Roles

| JP Term | TW Term | EN Term | Category | Notes |
|---------|---------|---------|----------|-------|
| ロール | 職能 | Role | 職能 | Tank／Healer／DPS |
| タンク | 坦克 | Tank | 職能 | 承受傷害 |
...
| 占星術士 | 占星術師 | Astrologian | 職業 | 補師（純治癒）；AST |
...
| Thancred | 桑克雷德 | Thancred | 角色 | EN 直查 |
| Y'shtola | 雅修特拉 | Y'shtola | 角色 | EN 直查 |
| G'raha Tia | 格拉哈 | G'raha Tia | 角色 | Crystal Exarch；EN 直查 |
| G'raha | 格拉哈 | G'raha Tia | 角色 | Reddit 常見縮寫 |
| Gra'ha | 格拉哈 | G'raha Tia | 角色 | Reddit 常見拼法變體 |
